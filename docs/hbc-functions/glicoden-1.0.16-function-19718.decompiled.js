...
==> 000003f7: <NewObjectWithBufferLong>: <Reg8: 2, UInt16: 3, UInt16: 2, UInt32: 49840, UInt32: 195396>  # Object: {'t': 'La Méthode GLICODEN', 's': 'Lire chaque plat avec 4 questions'}
==> 00000405: <NewObject>: <Reg8: 4>
==> 00000407: <LoadConstString>: <Reg8: 3, string_id: 28047>  # String: 'Pas besoin d’apprendre par cœur mille aliments. Il suffit de regarder chaque plat avec 4 questions toujours identiques : c’est la Méthode GLICODEN. Tu les retrouves sur chaque fiche de l’app.' (String)
...
==> 0000043e: <LoadConstString>: <Reg8: 5, string_id: 28603>  # String: 'Quand tu auras ces 4 questions en tête, tu sauras lire même un plat que l’app n’a jamais vu. C’est le but de GLICODEN : te rendre bon tout seul.' (String)
...
==> 00000463: <LoadConstString>: <Reg8: 3, string_id: 25465>  # String: 'GLICODEN te montre deux choses sur chaque aliment : l’impact sur la glycémie et les calories. Elles semblent pareilles, mais les confondre mène à l’erreur.' (String)
...
==> 00000bbe: <LoadConstString>: <Reg8: 8, string_id: 23911>  # String: 'Comment on lit un plat : la Méthode GLICODEN regarde quatre choses ensemble : quantité de glucides, vitesse (IG), équilibre (fibres, protéines et graisses qui freinent la montée) et préparation (cuisson). Le verdict naît de la charge globale, pas de l’IG seul.' (String)
