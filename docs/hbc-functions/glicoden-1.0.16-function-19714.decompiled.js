...
==> 000003f7: <NewObjectWithBufferLong>: <Reg8: 2, UInt16: 3, UInt16: 2, UInt32: 49840, UInt32: 194677>  # Object: {'t': 'El Método GLICODEN', 's': 'Leer cada plato con 4 preguntas'}
==> 00000405: <NewObject>: <Reg8: 4>
==> 00000407: <LoadConstString>: <Reg8: 3, string_id: 27637>  # String: 'No hace falta aprenderse de memoria mil alimentos. Basta mirar cada plato con 4 preguntas siempre iguales: es el Método GLICODEN. Las encuentras en cada ficha de la app.' (String)
...
==> 0000043e: <LoadConstString>: <Reg8: 5, string_id: 24097>  # String: 'Cuando tengas en la cabeza estas 4 preguntas, sabrás leer también un plato que la app no ha visto nunca. Es el objetivo de GLICODEN: que sepas hacerlo tú solo.' (String)
...
==> 00000463: <LoadConstString>: <Reg8: 3, string_id: 25467>  # String: 'GLICODEN te muestra dos cosas de cada alimento: el impacto en la glucosa y las calorías. Parecen lo mismo, pero confundirlas te lleva por mal camino.' (String)
...
==> 00000bbe: <LoadConstString>: <Reg8: 8, string_id: 24213>  # String: 'Cómo leemos un plato: el Método GLICODEN mira cuatro cosas a la vez: cantidad de carbohidratos, velocidad (IG), equilibrio (fibra, proteínas y grasas que frenan la subida) y preparación (cocción). El veredicto nace de la carga total, no del IG solo.' (String)
