...
export const fr = {
  ...
  home: {
    ...
    verified: {
      aria: 'Contenus disponibles', foods_one: '{{count}} aliment', foods_other: '{{count}} aliments', recipes_one: '{{count}} recette', recipes_other: '{{count}} recettes',
    ...
    quick: {
      ...
      search: { label: 'Rechercher un aliment', note: 'Catalogue alimentaire' }, barcode: { label: 'Lire une étiquette', note: 'Données d’Open Food Facts' },
  ...
  analysis: {
    ...
    text: {
      ...
      privacy: 'Le navigateur envoie uniquement la description, la langue et un code temporaire pour effectuer l’analyse. Aucune image n’est envoyée dans ce mode.',
    },
    photo: {
    ...
    result: {
      ...
      wholeDishOverride: 'Valeurs du plat entier',
    },
    pump: {
      kicker: 'Récapitulatif des glucides', title: 'Glucides estimés',
      body: 'Estimation fondée sur les ingrédients et les quantités reconnus. Vérifiez les données : ceci n’est pas une indication de dosage.', outputAria: 'Glucides estimés : {{carbs}} grammes',
      partial_one: 'Estimation partielle : {{count}} ingrédient n’est pas inclus dans le calcul. Corrigez les ingrédients et les quantités avant d’utiliser la valeur.',
      partial_other: 'Estimation partielle : {{count}} ingrédients ne sont pas inclus dans le calcul. Corrigez les ingrédients et les quantités avant d’utiliser la valeur.',
      complete: 'Estimation complète : tous les ingrédients reconnus sont inclus. Vérifiez tout de même les ingrédients et les quantités : ceci n’est pas une indication de dosage.',
    },
    ...
    portion: {
      aria: 'Taille de la portion', small: 'Petite', medium: 'Moyenne', large: 'Grande',
      hint: 'Les options partent des quantités détectées par l’analyse ; si vous modifiez les grammes, l’option sélectionnée est annulée.',
    },
    weight: {
  ...
  catalog: {
    ...
    list: {
      backCatalog: '← Catalogue des aliments', backAll: '← Tous les aliments', missing: 'L’aliment demandé n’existe pas dans le catalogue local.',
      kicker: 'Catalogue alimentaire', title: 'Recherchez ce que', accent: 'vous mangez.',
  ...
  barcode: {
    ...
    product: {
      normalized: 'Produit trouvé · {{code}}', per100: '{{label}} / 100 g', declaredServing: 'Portion déclarée : {{value}}',
      dryCorrection: 'Valeurs adaptées au produit sec', uniqueMatch: 'Aliment reconnu dans le catalogue :',
      uniqueMatchBody: '{{food}}. CG {{glycemicLoad}} · {{band}}, calculées avec l’IG local et les glucides déclarés.',
      missingGi: 'Les données sont insuffisantes pour calculer l’IG et la CG. Ces valeurs ne sont pas estimées.',
      ambiguous: 'Le nom ne désigne pas un seul aliment dans le catalogue local. Les données sont insuffisantes pour calculer l’IG et la CG, et le produit ne peut pas être ajouté.',
    },
    scan: {
    ...
    panel: {
      ...
      privacy: 'Le scan en direct est disponible uniquement avec une connexion sécurisée et un navigateur compatible. Les photos et les vidéos restent sur l’appareil ; seul le code lu est envoyé. L’image du produit, si elle est disponible, provient d’Open Food Facts.',
    },
  },
  recipes: {
    ...
    detail: {
      ...
      procedure: 'Préparation', alternatives: 'Autres possibilités', alternativeBase: 'Base : {{base}} · IG {{gi}}', advice: 'Contexte et conseils',
    },
    list: {
      missingTitle: 'Recette introuvable', missingBody: 'L’identifiant ne correspond pas aux {{count}} recettes disponibles.',
      verified_one: '{{count}} recette disponible', verified_other: '{{count}} recettes disponibles', title: 'Recettes avec valeurs', accent: 'par portion.',
      subtitle: 'Chaque recette ouvre une fiche dédiée. Les images sont affichées lorsqu’elles correspondent à la recette.',
  ...
  diary: {
    ...
    manual: {
      ...
      estimateNote: 'Estimation : utilise un seul aliment correspondant dans le catalogue lorsqu’il est disponible ; sinon, applique des règles locales prudentes pour les produits zéro/light, les sucres et les liquides. Aucune donnée nutritionnelle externe n’est utilisée.',
  ...
  learn: {
    ...
    chapter: {
      ...
      missing: 'Le chapitre demandé ne figure pas parmi les contenus disponibles.',
    },
    quiz: {
      ...
      editorialState: 'Statut éditorial : {{state}}. Les questions doivent encore être révisées et ne constituent pas des indications cliniques.',
      ...
      persistenceError: 'Le navigateur n’a pas confirmé l’enregistrement du résultat sur l’appareil.', progress: 'Question {{current}} sur {{total}}', difficulty: 'Difficulté {{value}}',
    ...
    list: {
      ...
      subtitle: 'Toutes les sections disponibles sont visibles. Les exemples ouvrent une fiche aliment uniquement lorsqu’un lien est disponible.',
      dailyQuiz: 'Quiz quotidien', quizDataset: '10 questions disponibles', section: 'Section {{number}}',
      chapter: 'Chapitre {{ordinal}} · {{minutes}} min', footer: 'Contenus éducatifs ; blocs personnels et commerciaux exclus.', method: 'Comment fonctionne la méthode',
    },
  },
  method: {
    hero: {
    ...
    formula: {
      kicker: 'Comment la CG est calculée', title: 'De l’ingrédient au plat', expression: 'CG = IG × glucides disponibles de la portion ÷ 100',
      body: 'La charge glycémique du plat est la somme des contributions des ingrédients reconnus. Sous 5 g de glucides, la tranche est négligeable ; sinon la valeur de base est faible jusqu’à CG 10, moyenne jusqu’à 19 et élevée à partir de 20. Les règles de calcul peuvent relever la tranche pour les profils rapides ou liquides.',
    },
    sources: {
      title: 'D’où viennent les chiffres', catalog: 'Le catalogue et les recettes utilisent uniquement les données alimentaires disponibles dans l’app.',
      photo: 'La photo résout les ingrédients par rapport au même catalogue local.',
      barcode: 'L’étiquette utilise les valeurs déclarées par Open Food Facts ; l’IG et la CG n’apparaissent que lorsqu’un seul aliment est reconnu dans le catalogue local.',
  ...
  share: {
    ...
    food: { impactBand: 'Tranche d’impact', note: 'Valeurs et classification du catalogue local.' },
    recipe: { subtitle_one: '{{category}} · {{count}} portion', subtitle_other: '{{category}} · {{count}} portions', note: 'Valeurs calculées à partir des données par portion de la recette.' },
  ...
  errors: {
    ...
    photo: {
      ...
      network: 'Échec de la connexion. Vérifiez le réseau et réessayez.', sameOrigin: 'Le service d’analyse photo est indisponible. Réessayez plus tard.',
    },
    text: {
      ...
      network: 'Échec de la connexion. Vérifiez le réseau et réessayez.', sameOrigin: 'Le service d’analyse de texte est indisponible. Réessayez plus tard.',
    },
    barcode: {
      invalidResponse: 'Impossible de lire les données du produit.', invalidCode: 'Code invalide.', network: 'Le service de recherche de produits est inaccessible.',
      proxyUnavailable: 'La recherche de produits est actuellement indisponible.', invalidJson: 'Impossible de lire les données du produit.', lookupFailed: 'La recherche du produit a échoué.',
    },
  },
