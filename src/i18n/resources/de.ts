...
export const de = {
  ...
  home: {
    ...
    verified: {
      aria: 'Verifizierte Inhalte verfügbar', foods_one: '{{count}} Lebensmittel', foods_other: '{{count}} Lebensmittel', recipes_one: '{{count}} Rezept', recipes_other: '{{count}} Rezepte',
    ...
    quick: {
      ...
      search: { label: 'Lebensmittel suchen', note: 'Verifizierter Katalog' }, barcode: { label: 'Etikett lesen', note: 'Open Food Facts über Proxy' },
  ...
  analysis: {
    ...
    text: {
      ...
      privacy: 'Der Browser sendet nur Text, Sprache und eine flüchtige Kennung an die Same-Origin-Grenze. Diesem Modus wird kein Bild zugeordnet.',
    },
    photo: {
    ...
    result: {
      ...
      wholeDishOverride: 'Überschreibung des ganzen Gerichts',
    },
    pump: {
      kicker: 'Insulinpumpen-Steuerung', title: 'Einzugebende Kohlenhydrate',
      body: 'Wert aus der vollständigen Auswirkung, einschließlich einer möglichen Überschreibung des ganzen Gerichts.',
      outputAria: 'Einzugebende Kohlenhydrate: {{carbs}} Gramm',
      partial_one: 'Teilweise Schätzung: {{count}} Zutat ist von der Nährwertberechnung ausgeschlossen. Korrigiere Zutaten und Mengen, bevor du den Wert verwendest.',
      partial_other: 'Teilweise Schätzung: {{count}} Zutaten sind von der Nährwertberechnung ausgeschlossen. Korrigiere Zutaten und Mengen, bevor du den Wert verwendest.',
      complete: 'Vollständige Berechnung: Alle erkannten Zutaten sind enthalten. Prüfe Zutaten und Gramm trotzdem vor der Bestätigung am Gerät.',
    },
    impact: {
    ...
    portion: {
      aria: 'Portionsvorgabe', small: 'Klein', medium: 'Mittel', large: 'Groß',
      hint: 'Jede Vorgabe beginnt mit dem ursprünglichen Analyse-Snapshot; eine manuelle Änderung der Gramm hebt die Auswahl auf.',
    },
    weight: {
  ...
  catalog: {
    ...
    list: {
      backCatalog: '← Lebensmittelkatalog', backAll: '← Alle Lebensmittel', missing: 'Das angeforderte Lebensmittel existiert nicht im eingebetteten Katalog.',
      kicker: 'Verifizierter Katalog', title: 'Suche, was du', accent: 'gerade isst.',
  ...
  barcode: {
    ...
    product: {
      normalized: 'Normalisiertes Produkt · {{code}}', per100: '{{label}} / 100 g', declaredServing: 'Angegebene Portion: {{value}}',
      dryCorrection: 'Verifizierte Korrektur für Trockenprodukt', uniqueMatch: 'Eindeutige lokale Übereinstimmung:',
      uniqueMatchBody: '{{food}}. GL {{glycemicLoad}} · {{band}}, berechnet mit lokalem GI und angegebenen Kohlenhydraten.',
      missingGi: 'Die lokale Übereinstimmung hat keinen GI oder das Produkt enthält keine gültigen Kohlenhydratangaben. GI und GL werden nicht erfunden.',
      ambiguous: 'Der Name lässt sich im lokalen Katalog nicht eindeutig auflösen. GI und GL werden nicht erfunden und das Produkt kann nicht hinzugefügt werden.',
    },
    scan: {
    ...
    panel: {
      ...
      privacy: 'Die Live-Kamera erfordert HTTPS oder localhost. Bilder und Videos bleiben im Browser; nur der erkannte Code geht an den Same-Origin-Proxy. Das entfernte Produktbild wird nicht geladen.',
    },
  },
  recipes: {
    ...
    detail: {
      ...
      procedure: 'Zubereitung', alternatives: 'Eingebettete Alternativen', alternativeBase: 'Basis: {{base}} · GI {{gi}}', advice: 'Kontext und Tipps',
    },
    list: {
      missingTitle: 'Rezept nicht gefunden', missingBody: 'Die Kennung entspricht keinem der {{count}} eingebetteten Rezepte.',
      verified_one: '{{count}} verifiziertes Rezept', verified_other: '{{count}} verifizierte Rezepte', title: 'Rezepte mit Werten', accent: 'pro Portion.',
      subtitle: 'Jedes Rezept öffnet eine eigene Detailseite. Bilder werden nur angezeigt, wenn ID und Name mit der verifizierten Karte 1.0.16 übereinstimmen.',
  ...
  diary: {
    ...
    manual: {
      ...
      estimateNote: 'Verifizierte Schätzung: eindeutige Katalogübereinstimmung, falls verfügbar; sonst lokale Regeln für Zero/Light, Zucker/Flüssigkeiten und eine vorsichtige Rückfallregel. Keine externen Nährwertdaten.',
  ...
  learn: {
    ...
    chapter: {
      ...
      missing: 'Das angeforderte Kapitel existiert nicht im eingebetteten Datensatz.',
    },
    quiz: {
      ...
      editorialState: 'Redaktioneller Status: {{state}}. Die eingebetteten Fragen müssen noch geprüft werden und sind keine klinischen Hinweise.',
      ...
      persistenceError: 'Der Browser hat die Speicherung in localStorage nicht bestätigt.', progress: 'Frage {{current}} von {{total}}', difficulty: 'Schwierigkeit {{value}}',
    ...
    list: {
      ...
      subtitle: 'Alle eingebetteten Abschnitte sind sichtbar. Beispiele öffnen eine Lebensmittelseite nur bei verifiziertem `foodId`-Link.',
      dailyQuiz: 'Tägliches Quiz', quizDataset: '10 Fragen aus dem eingebetteten Datensatz', section: 'Abschnitt {{number}}',
      chapter: 'Kapitel {{ordinal}} · {{minutes}} Min.', footer: 'Eingebettete Bildungsinhalte; persönliche und kommerzielle Blöcke ausgeschlossen.', method: 'So funktioniert die Methode',
    },
  },
  method: {
    hero: {
    ...
    formula: {
      kicker: 'Verifizierte Formel', title: 'Von der einzelnen Zutat zum Gericht', expression: 'GL = GI × verfügbare Kohlenhydrate der Portion ÷ 100',
      body: 'Die glykämische Last des Gerichts ist die Summe der Beiträge aufgelöster Zutaten. Unter 5 g Kohlenhydraten ist der Bereich vernachlässigbar; ansonsten ist der Basiswert bis GL 10 niedrig, bis 19 mittel und ab 20 hoch. Verifizierte Regeln können den Bereich bei schnellen oder flüssigen Profilen anheben.',
    },
    sources: {
      title: 'Woher die Zahlen stammen', catalog: 'Katalog und Rezepte verwenden ausschließlich verifizierte eingebettete Datensätze.',
      photo: 'Das Foto gleicht Zutaten mit demselben lokalen Katalog ab.',
      barcode: 'Das Etikett nutzt die von Open Food Facts angegebenen Makronährstoffe über einen Same-Origin-Proxy; GI und GL erscheinen nur bei eindeutiger lokaler Übereinstimmung.',
  ...
  share: {
    ...
    food: { impactBand: 'Auswirkungsbereich', note: 'Werte und Klassifizierung aus dem verifizierten lokalen Katalog.' },
    recipe: { subtitle_one: '{{category}} · {{count}} Portion', subtitle_other: '{{category}} · {{count}} Portionen', note: 'Aus eingebetteten Rezeptdaten pro Portion skalierte Werte.' },
  ...
  errors: {
    ...
    photo: {
      ...
      network: 'Verbindung fehlgeschlagen. Prüfe das Netzwerk und versuche es erneut.', sameOrigin: 'Der Endpunkt für die Fotoanalyse muss Same-Origin sein.',
    },
    text: {
      ...
      network: 'Verbindung fehlgeschlagen. Prüfe das Netzwerk und versuche es erneut.', sameOrigin: 'Der Endpunkt für die Textanalyse muss Same-Origin sein.',
    },
    barcode: {
      invalidResponse: 'Ungültige Barcode-Antwort.', invalidCode: 'Ungültiger Code.', network: 'Barcode-Dienst nicht erreichbar.',
      proxyUnavailable: 'Barcode-Proxy nicht verfügbar oder nicht konfiguriert.', invalidJson: 'Ungültige JSON-Antwort des Barcode-Proxys.', lookupFailed: 'Barcode-Suche fehlgeschlagen.',
    },
  },
